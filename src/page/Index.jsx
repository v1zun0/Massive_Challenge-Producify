  ...
  return (
    <>
      ...
      <body style={{backgroundColor: "#e7f9ff"}}>
        ...
        <div>
          <a type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" aria-label="Slide 1" className="artikel-active m-3">New project</a>
          <a type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" aria-label="Slide 2" className="artikel-active m-3">Tips & Guide</a>
          <a type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" aria-label="Slide 3" className="artikel-active m-3">Chat with your friend</a>
        </div>
