...
export default function UpgradeMonthly() {
                ...
                <div className="card shadow" style={{ width: '60%', height: '60%', borderRadius: '15px', backgroundColor: '#9BD5E9' }}>
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-center">
                      <a href="/UpgradeMonthly" className="btn m-1" style={{ borderRadius: '20px', width: '100%', backgroundColor: 'whitesmoke', color: 'black' }}>
                        monthly
                      </a>
                      <a href="/UpgradeYearly" className="btn m-1" style={{ borderRadius: '20px', width: '100%', backgroundColor: '#2193b9', color: 'white' }}>
                        Yearly
                      </a>
                    </div>
                  </div>
