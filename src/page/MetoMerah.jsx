...
export default function MetoMerah() {
                ...
                <div className="rounded-4 card p-4 shadow">
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <div className="position-absolute top-50 end-0 translate-middle-y pe-4">
                      <a href="/Mbanking" type="button" className="btn d-grid text-white ms-auto" style={{ height: '35px', width: '150px', borderRadius: '50px', backgroundColor: '#cf0000' }}>
                        Connect
                      </a>
                    </div>
                  </div>
